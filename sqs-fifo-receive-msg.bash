...
while true
do
	RCV_HANDLE=`aws sqs receive-message --region $REGION --endpoint-url $SQS_URL --queue-url $QUEUE_URL|tee -a sqs_fifo_messages.txt|grep "ReceiptHandle"|awk -F": \"" '{print $2}'`
	[ -z "$RCV_HANDLE" ] && break
